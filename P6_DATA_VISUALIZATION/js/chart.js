...
d3.csv("data/titanic_data.csv", function(data) {
	...
	{ // survivor by gender
		...
		chart1.assignColor("Not Survived", "lightcoral");
		chart1.draw();
		svg1.append("text")
	...
	{ // survivor by class
		...
		chart2.assignColor("Not Survived", "lightcoral");
		chart2.draw();
		svg1.append("text")
	...
	{ // survivors by both class and gender
		...
		chart3.addCategoryAxis("x", ["Sex", "Pclass"]);
		chart3.addMeasureAxis("y", "Count");
		chart3.addSeries("Status", dimple.plot.bar);
		chart3.addLegend(400, 100, 100, 100, "left");
		chart3.assignColor("Not Survived", "lightcoral");
		chart3.draw();
		svg1.append("text")
			...
			.style("font-family", "sans-serif")
			.style("font-weight", "bold")
			.text("SURVIVOR V/S GENDER WITH DIFFERENT CLASSES");
